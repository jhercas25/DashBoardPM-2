...
--
-- Table structure for table `productotemp`
--
...
--
-- Dumping data for table `productotemp`
--

LOCK TABLES `productotemp` WRITE;
/*!40000 ALTER TABLE `productotemp` DISABLE KEYS */;
/*!40000 ALTER TABLE `productotemp` ENABLE KEYS */;
UNLOCK TABLES;
