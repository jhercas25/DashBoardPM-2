...
--
-- Table structure for table `detalleinvlotfevtemp`
--

DROP TABLE IF EXISTS `detalleinvlotfevtemp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `detalleinvlotfevtemp` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `ILF` int unsigned DEFAULT NULL,
...
--
-- Dumping data for table `detalleinvlotfevtemp`
--

LOCK TABLES `detalleinvlotfevtemp` WRITE;
/*!40000 ALTER TABLE `detalleinvlotfevtemp` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalleinvlotfevtemp` ENABLE KEYS */;
UNLOCK TABLES;
