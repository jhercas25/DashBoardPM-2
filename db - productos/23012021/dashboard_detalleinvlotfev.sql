...
--
-- Table structure for table `detalleinvlotfev`
--

DROP TABLE IF EXISTS `detalleinvlotfev`;
...
--
-- Dumping data for table `detalleinvlotfev`
--

LOCK TABLES `detalleinvlotfev` WRITE;
/*!40000 ALTER TABLE `detalleinvlotfev` DISABLE KEYS */;
/*!40000 ALTER TABLE `detalleinvlotfev` ENABLE KEYS */;
UNLOCK TABLES;
