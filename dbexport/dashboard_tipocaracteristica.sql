...
CREATE TABLE `tipocaracteristica` (
  `idTipoCaracteristica` int DEFAULT NULL,
  `Nombre_TipoCaracteristica` varchar(255) DEFAULT NULL
...
INSERT INTO `tipocaracteristica` VALUES (1,'Talla'),(2,'Tamaño'),(3,'Color'),(4,'Medida'),(5,'Hemisferio'),(6,'Sexo');
